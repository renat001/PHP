<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $email = $_POST['email'];
        $tempPass = $_POST['password']; // Password input from the from
        ...
        {
            echo "Ypu need to fill all the fields.";
        }
        else
        {
            ...
            if($tempSQL->rowCount() > 0)
            {
                ...
                $sql = "INSERT INTO users (name, surname, username, email, password) VALUES(:name, :surname, :email, :password)";
